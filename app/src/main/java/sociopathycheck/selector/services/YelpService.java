        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                for (int i = 0; i < businessesJSON.length(); i++) {
                    ...
                    JSONArray neighborhoodsJSON = restaurantJSON.getJSONObject("location").getJSONArray("neighborhoods");
                    for (int y = 0; y < neighborhoodsJSON.length(); y++) {
                        neighborhoods.add(neighborhoodsJSON.get(y).toString());
                    }
